...
console.log(detectTriangle(10, 5, 10));
console.log(detectTriangle(10, 5, 3));

// Trigger Validasi
console.log(detectTriangle(10, 5, "5"));
console.log(detectTriangle(10, "2", 3 ));
console.log(detectTriangle("7", 10, 3 ));